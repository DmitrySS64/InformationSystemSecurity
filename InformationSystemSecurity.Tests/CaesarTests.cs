...
public class CaesarTests
{
    ...
    public void CaesarSimpleAdditiveHomomorphism_NotHomomorphic(string textA, string textB, string key)
    {
        ...
        var sumCipher = TextConverter.AddTexts(caesar.Encrypt(textA, key), caesar.Encrypt(textB, key));
        var sumPlain = TextConverter.AddTexts(textA, textB);
    ...
    public void CaesarSimpleKeyAddition_ResultsDiffer(string plainText, string key1, string key2)
    {
        ...
        var sumCipher = TextConverter.AddTexts(caesar.Encrypt(plainText, key1), caesar.Encrypt(plainText, key2));
        var keySum = TextConverter.AddTexts(key1, key2);
    ...
    public void SBlockAdditiveHomomorphism_NotHomomorphic(string textA, string textB, string key)
    {
        ...
        var sumCipher = TextConverter.AddTexts(sBlockCipher.Encrypt(textA), sBlockCipher.Encrypt(textB));
        var sumPlain = TextConverter.AddTexts(textA, textB);
    ...
    public void SBlockKeyAddition_ResultsDiffer(string plainText, string key1, string key2)
    {
        ...
        var sumCipher = TextConverter.AddTexts(cipher1.Encrypt(plainText), cipher2.Encrypt(plainText));
        var keySum = TextConverter.AddTexts(key1, key2);
