...
public class SBlockTests
{
    ...
    {
        var sumCipher = TextConverter.AddTexts(SBlockCipher.MergeBlock(textA, key), SBlockCipher.MergeBlock(textB, key));
    ...
    {
        var sumCipher = TextConverter.AddTexts(SBlockCipher.MergeBlock(plainText, key1), SBlockCipher.MergeBlock(plainText, key2));
